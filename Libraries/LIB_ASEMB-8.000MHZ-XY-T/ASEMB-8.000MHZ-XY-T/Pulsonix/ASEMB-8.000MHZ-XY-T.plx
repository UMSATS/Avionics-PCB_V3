...
(library Library_1
	...
	(patternDef "ASEMB" (originalName "ASEMB")
		...
		(layerContents (layerNumRef 18)
			(arc (pt -1.05, -1.85) (radius 0) (width 0.2))
		)
	)
	(symbolDef "ASEMB-8.000MHZ-XY-T" (originalName "ASEMB-8.000MHZ-XY-T")
	...
	(compDef "ASEMB-8.000MHZ-XY-T" (originalName "ASEMB-8.000MHZ-XY-T") (compHeader (numPins 4) (numParts 1) (refDesPrefix Y)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "ASEMB-8.000MHZ-XY-T"))
		...
		(attr "<Hyperlink>" "https://abracon.com/Oscillators/ASEMB.pdf")
	)
